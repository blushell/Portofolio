		...
		<div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
			...
			>
				...
				<div class="p-6 space-y-4">
					<div class="space-y-2">
						<h3 class="text-dracula-foreground font-bold text-lg">
							{{ startup.name }}
						</h3>
						<p class="text-dracula-comment">
							{{ startup.description }}
					...
					<div class="pt-4 space-y-2">
						...
						<div class="relative group">
							...
							<!-- Tooltip -->
							<div
								class="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 py-2 px-4 bg-dracula-background text-dracula-comment text-sm rounded shadow-lg opacity-0 group-hover:opacity-100 transition-opacity duration-200 whitespace-nowrap pointer-events-none border border-dracula-purple"
							>
